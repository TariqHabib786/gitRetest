...
@When("^User click on 'yes' radio button for subscribe$")
public void user_click_on_yes_radio_button_for_subscribe() throws Throwable {
		Utility.screenshot(driver);
...
@When("^User click on continue botton$")
